...
public class infoView extends AbstractView {
    ...
    public infoView(SimulatorModel sim) {
        ...
        currentDay = new JLabel("Day : " + sim.getCurrentDay());
        ...
        currentDay.setBounds(5, 20 , 200, 50);
        revenueCount.setBounds(5, 40 , 200, 50);
        expectedRevenue.setBounds(5, 60, 200, 50);
        currentCount.setBounds(5, 80 , 200, 50);
        carCount.setBounds(5, 100 , 200, 50);
    ...
    public void updateView() {
        ...
        currentDay.setText("Day : " + sim.getCurrentDay());
